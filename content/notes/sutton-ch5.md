...
Incremental Update
![Incremental update](https://kwquan.github.io/rl-journal/images/incremental_update.png)
...
First Visit
![First-visit monte-carlo](https://kwquan.github.io/rl-journal/images/first_visit_monte.png)
...
Every Visit
![Every-visit monte-carlo](https://kwquan.github.io/rl-journal/images/every_visit_monte.png)
...
For the next chapter, we shall combine the ideas of dynamic programming & monte-carlo into temporal-difference learning. The one idea central & novel to reinforcement-learning
